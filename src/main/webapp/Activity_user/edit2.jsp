				...
				<ul>
					<li><div class="inputview1">
						<span class="inputspan"> 
								...
								<input class="inputinput" type="text"  name="name" value="${requestScope.info.name}" style=" width:180px;">
								</span>
							    <span class="inputspan"> 
								...
								<input class="inputinput" type="hidden" name="isgroup" value="-1"> 	
								<input class="inputinput" type="hidden" name="ylevel" value="-1"> 	
								<input class="inputinput" type="hidden" name="glevel" value="-1"> 	
								<input class="inputinput" type="hidden" name="slevel" value="-1"> 	
							
							</span>
							<span class="inputspan"> 
							<label class="inputtext" >备注: </label> 
							<textarea class="inputinput"  name="comments" style="width:180px;">${requestScope.info.comments}</textarea>	
						</span>
						</div>
					</li>
				</ul>
