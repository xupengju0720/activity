...
<body style="overflow:hidden;overflow-y:auto;">
	<script>
		...
		<form class="f1">
				...
				<input class="inputinput"  name=tprogress style="width: 300px;margin-left: 65px;"/>
				<br>
				<label class="inputtext ">学生状况:</label>
				<input class="inputinput"  name="sprogress" style="width: 300px;margin-left: 65px;"/>
				<br>
				<label class="inputtext ">市场状况:</label>
				<input class="inputinput"  name="cprogress" style="width: 300px;margin-left: 65px;"/>
				<br>
				<label class="inputtext ">日总结:</label>
					<textarea class="input" name="comments" style=" position: relative; padding-left:0px; top:5px; left:65px; width:300px; height:50px;border: solid 1px #A673AB;"></textarea>		
				</div>
