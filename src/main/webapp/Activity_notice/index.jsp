...
function openwin(){
	layer_show("部门信息","Activity_notice/edit",600,250);
	}
	
	function openedit(id){
	layer_show("部门信息","Activity_notice/edit?id="+id,600,250);
	}
	function del(id){
		$.post("Activity_notice/delete",{id:id},function(json){
			if(json.status>0){
				location.reload();
			}
	},"json")
...
<body>
   <span class="printtitle"></span>
     ...
     <form action="Activity_notice/index" method="post">
       <div class="searchview">
       <label class="searchtext"><b>名称：</b></label>
       	<input type="hidden" name="table" value="Activity_notice"/>
...
<div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="Activity_notice/index?pageno=${requestScope.result.first_pageno}">首页</a></li>
        <li class="paginItem"><a href="Activity_notice/index?pageno=${requestScope.result.pro_pageno}">上一页</a></li>
        <li class="paginItem"><a href="Activity_notice/index?pageno=${requestScope.result.next_pageno}">下一页</a></li>
        <li class="paginItem"><a href="Activity_notice/index?pageno=${requestScope.result.last_pageno}">末页</a></li>
        </ul>
    </div>
